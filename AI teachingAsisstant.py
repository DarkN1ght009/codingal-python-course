...
def complete_answer(question: str, max_rounds: int = 2) -> str:
    ...
    while rounds < max_rounds and looks_incomplete(ans) :
        cont_prompt = (
            ...
            "DO not repat earlier text"
            "Finish the incomplete point and coplete answer \n \n"
            f"Question{question}\n\n"
            f"Answer so far\n{ans}\n\nContinue"
        )
...
def main():
    ...
    st.write ("Welcome! You can ask me anything about various subjects and i will give an answer")
